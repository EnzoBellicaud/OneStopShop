...
# Email — defaults to console backend (no SMTP needed).
# Set EMAIL_HOST + credentials in .env to enable real email sending.
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@sunrise-oss.local")
